...
var GHOST_BLINKY_STATE = 0;  //1- moving; -1- eaten
var GHOST_BLINKY_EAT_TIMER = null;
var GHOST_BLINKY_AFFRAID_TIMER = null;
var GHOST_BLINKY_AFFRAID_STATE = 0; // 0 - not afraid, pacman did not eat big fruits
...
//moving speed smaller means faster
var GHOST_MOVING_SPEED = 15;
var GHOST_TUNNEL_MOVING_SPEED = 35;
var GHOST_AFFRAID_MOVING_SPEED = 40;// after eaten a big fruits
var GHOST_EAT_MOVING_SPEED = 6;// after eaten by pacman
...
function drawGhost(ghost) { 
	...
	//draw a ghost
	eval('drawHelperGhost(ctx, GHOST_' + ghost.toUpperCase() + '_POSITION_X, GHOST_' + 
	ghost.toUpperCase() + '_POSITION_Y, GHOST_' + ghost.toUpperCase() + '_DIRECTION, GHOST_' + 
	ghost.toUpperCase() + '_BODY_STATE, GHOST_' + ghost.toUpperCase() + '_STATE, GHOST_' + 
	ghost.toUpperCase() + '_AFFRAID_STATE)');
...
function affraidGhost(ghost) { //pac man ate big furit
...
function moveGhost(ghost) {// moving speed
